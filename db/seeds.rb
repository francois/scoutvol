...
ApplicationRecord.transaction do
  ...
  seasons = 2.times.map { Date.today.year + it }.map do |start_year|
    Season.create!(name: "#{start_year}-#{start_year.succ}", slug: SLUGS.shift)
  end

  seasons.each do |season|
    season.events.create!(title: "Vert & Or", start_at: next_sunday_on_or_after(tz.local(season.name.to_i, 8, 29, 10)), slug: SLUGS.shift, max_registrations: 12).tap { seed_registrations(4, it) }
    season.events.create!(title: "Vert & Or", start_at: next_sunday_on_or_after(tz.local(season.name.to_i, 9, 10, 10)), slug: SLUGS.shift, max_registrations: 12).tap { seed_registrations(8, it) }
    ...
    season.events.create!(title: "Cannet-🌎-thon des fêtes", start_at: next_saturday_on_or_after(tz.local(season.name.to_i.succ, 1, 4, 9)), slug: SLUGS.shift, max_registrations: 6).tap { seed_registrations(6, it) }
    ...
    season.events.create!(title: "Cannet-🌎-thon des fêtes", start_at: next_sunday_on_or_after(tz.local(season.name.to_i.succ, 1, 4, 9)), slug: SLUGS.shift, max_registrations: 6).tap { seed_registrations(5, it) }
    season.events.create!(title: "Cannet-🌎-thon des fêtes", start_at: next_sunday_on_or_after(tz.local(season.name.to_i.succ, 1, 4, 11)), slug: SLUGS.shift, max_registrations: 6).tap { seed_registrations(2, it) }
    season.events.create!(title: "Cannet-🌎-thon des fêtes", start_at: next_sunday_on_or_after(tz.local(season.name.to_i.succ, 1, 4, 13)), slug: SLUGS.shift, max_registrations: 6).tap { seed_registrations(5, it) }
    season.events.create!(title: "Cannet-🌎-thon des fêtes", start_at: next_sunday_on_or_after(tz.local(season.name.to_i.succ, 1, 4, 15)), slug: SLUGS.shift, max_registrations: 6).tap { seed_registrations(1, it) }
    ...
    season.events.create!(title: "Cannet-🌎-thon de Pâques", start_at: next_saturday_on_or_after(tz.local(season.name.to_i.succ, 5, 1, 15)), slug: SLUGS.shift, max_registrations: 6).tap { seed_registrations(3, it, Faker::Internet.email) }

    season.events.create!(title: "Cannet-🌎-thon de Pâques", start_at: next_sunday_on_or_after(tz.local(season.name.to_i.succ, 5, 1, 9)), slug: SLUGS.shift, max_registrations: 6)
    season.events.create!(title: "Cannet-🌎-thon de Pâques", start_at: next_sunday_on_or_after(tz.local(season.name.to_i.succ, 5, 1, 11)), slug: SLUGS.shift, max_registrations: 6)
    season.events.create!(title: "Cannet-🌎-thon de Pâques", start_at: next_sunday_on_or_after(tz.local(season.name.to_i.succ, 5, 1, 13)), slug: SLUGS.shift, max_registrations: 6).tap { seed_registrations(2, it, Faker::Internet.email) }
    season.events.create!(title: "Cannet-🌎-thon de Pâques", start_at: next_sunday_on_or_after(tz.local(season.name.to_i.succ, 5, 1, 15)), slug: SLUGS.shift, max_registrations: 6)
    ...
    season.events.create!(title: "Phoenix", start_at: next_sunday_on_or_after(tz.local(season.name.to_i, 12, 21, 20)), slug: SLUGS.shift, max_registrations: 8).tap { seed_registrations(3, it) }
    ...
    season.events.create!(title: "Pif", start_at: tz.local(season.name.to_i.succ, 6, 28, 22), slug: SLUGS.shift, max_registrations: 10).tap { seed_registrations(9, it) }
    season.events.create!(title: "Pif", start_at: tz.local(season.name.to_i.succ, 6, 29, 22), slug: SLUGS.shift, max_registrations: 10).tap { seed_registrations(10, it) }
